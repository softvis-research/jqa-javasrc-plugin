...
import org.unileipzig.jqassistant.plugin.parser.test.set.scanner.generics.GenericType;
...
public class GenericsIT extends AbstractPluginIT {
    ...
    public void testGenericType() throws IOException, NoSuchMethodException {
		...
		final String FILE_DIRECTORY_PATH = "src/test/java/org/unileipzig/jqassistant/plugin/parser/test/set/scanner/generics/";
      ...
      //  assertThat(query("MATCH (g:Type)-[:DECLARES]->(c:Constructor) RETURN c").getColumn("c"), hasItem(constructorDescriptor(GenericType.class)));
