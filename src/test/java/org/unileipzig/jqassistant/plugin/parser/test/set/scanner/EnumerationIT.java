...
import org.unileipzig.jqassistant.plugin.parser.test.set.scanner.enumeration.EnumerationType;
...
public class EnumerationIT extends AbstractPluginIT {
    ...
    public void testEnumerationType() throws NoSuchFieldException {
    	...
    	final String TYPE_DIRECTORY_PATH = "src/test/java/org/unileipzig/jqassistant/plugin/parser/test/set/scanner/enumeration/";
